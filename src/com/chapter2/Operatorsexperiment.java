 ...
 * @author rabi
 * 
 * They are called "unary" from the word "uno", which means "one". 
 * 
 * operation is called postfix: it is performed after the main expression
 * 
...
//		byte _plp=(_ba+_bb);//possible loss of precision 
		// because internally java use arithmetic operator as max(int, type of a, type
		// of b)
		int _cc = _ba + _bb;
